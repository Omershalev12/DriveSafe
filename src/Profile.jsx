...
const Profile = () => {
    ...
    return (
        <div className="app">
            ...
            <div className='article'><h2>My Profile</h2></div>
            <img className='profile' src="profile pic.png" alt="" height={100} width={100}/>
            <div className='article'><h4>David Cohen</h4></div>
            ...
            <footer className="app-footer">
                <nav className="navbar">
                    <ul className="nav-list">
                        ...
                        <li className="nav-item"><a className='link' href='./'>Profile</a></li>
                    </ul>
                </nav>
            </footer>
        </div>
